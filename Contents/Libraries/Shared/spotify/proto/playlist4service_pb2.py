...
Playlist4InboxErrorKind = enum_type_wrapper.EnumTypeWrapper(_PLAYLIST4INBOXERRORKIND)
_PLAYLIST4SERVICEMETHODKIND = _descriptor.EnumDescriptor(
...
Playlist4ServiceMethodKind = enum_type_wrapper.EnumTypeWrapper(_PLAYLIST4SERVICEMETHODKIND)
INBOX_NOT_ALLOWED = 2
...
_GETCURRENTREVISIONARGS = _descriptor.Descriptor(
...
_GETCHANGESINSEQUENCERANGEARGS = _descriptor.Descriptor(
...
_GETCHANGESINSEQUENCERANGEMATCHINGPL3VERSIONARGS = _descriptor.Descriptor(
...
_GETCHANGESINSEQUENCERANGERETURN = _descriptor.Descriptor(
...
_OBLITERATELISTARGS = _descriptor.Descriptor(
...
_UPDATEPUBLISHEDARGS = _descriptor.Descriptor(
...
_SYNCHRONIZEARGS = _descriptor.Descriptor(
...
_GETSNAPSHOTATREVISIONARGS = _descriptor.Descriptor(
...
_PLAYLIST4SERVICEEXCEPTION = _descriptor.Descriptor(
...
_SYNCHRONIZERETURN = _descriptor.Descriptor(
...
_PLAYLIST4SERVICECALL = _descriptor.Descriptor(
...
_PLAYLIST4SERVICERETURN = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='getSnapshotAtRevisionReturn', full_name='spotify.playlist4.proto.Playlist4ServiceReturn.getSnapshotAtRevisionReturn', index=8,
...
class GetChangesInSequenceRangeMatchingPl3VersionArgs(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
...
class GetChangesInSequenceRangeReturn(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
...
class Playlist4ServiceException(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
...
class ModifyReply(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
